...
public class Dice extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Number of Dices (1-5) :");
        ...
        jLabel4.setText("Dice 2");

        jLabel5.setFont(new java.awt.Font("Tahoma", 2, 18)); // NOI18N
        jLabel5.setText("Dice 5");

        jLabel6.setFont(new java.awt.Font("Tahoma", 2, 18)); // NOI18N
        jLabel6.setText("Dice 4");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
    	...
    	int numb = Integer.parseInt(jTextField1.getText());
    	if(numb>5) {
    		numb=5;
    	}else if(numb<1) {
    		numb=1;
    	...
    	case 4:
    		jLabel6.setText(String.valueOf(d4));
    	case 3:
    		jLabel3.setText(String.valueOf(d3));
    	case 2:
    		jLabel4.setText(String.valueOf(d2));
    	case 1:
    		jLabel2.setText(String.valueOf(d1));
    	break;
    	}
    }                                        
