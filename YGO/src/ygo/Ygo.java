...
public class Ygo extends javax.swing.JFrame {
    ...
    private void validationActionPerformed(java.awt.event.ActionEvent evt) {                                           
    	...
    	if(p2.isSelected()) {
    		...
    		@SuppressWarnings("unused")
			ThreePlayer window2 = new ThreePlayer(player1.getText(),player2.getText(),player3.getText(),lp);
    	}else if(p4.isSelected()) {
    		@SuppressWarnings("unused")
			FourPlayer window3 = new FourPlayer(player1.getText(),player2.getText(),player3.getText(),player4.getText(),lp);
    	}
    	this.dispose();
    }                                          
